                    ...
                    <?php foreach ($data['reminders'] as $index => $reminder): ?>
                        <div class="card">
                            <div class="card-header" id="reminderHeading-<?php echo $index; ?>">
                                <h5 class="mb-0">
                                    <button class="btn btn-link" data-toggle="collapse" data-target="#reminderCollapse-<?php echo $index; ?>" aria-expanded="true" aria-controls="reminderCollapse-<?php echo $index; ?>">
                                        <?php echo htmlspecialchars($reminder['subject']); ?> - <?php echo htmlspecialchars($reminder['reminder_time']); ?>
                                    </button>
                                </h5>
                            </div>
                            ...
                            <div id="reminderCollapse-<?php echo $index; ?>" class="collapse" aria-labelledby="reminderHeading-<?php echo $index; ?>" data-parent="#remindersAccordion">
                                <div class="card-body">
                                    <p><strong>Created on:</strong> <?php echo htmlspecialchars($reminder['create_at']); ?></p>
                                    <p><strong>Reminder Time:</strong> <?php echo htmlspecialchars($reminder['reminder_time']); ?></p>
                                    <p><strong>Status:</strong> <?php echo $reminder['completed'] ? 'Completed' : 'Not Completed'; ?></p>
                                </div>
                            </div>
                        </div>
                    <?php endforeach; ?>
                ...
                <div id="mostRemindersUserAccordion">
                    <?php if ($data['mostRemindersUser']): ?>
                        <div class="card">
                            ...
                            <div id="mostRemindersUserCollapse" class="collapse" aria-labelledby="mostRemindersUserHeading" data-parent="#mostRemindersUserAccordion">
                                <div class="card-body">
                    ...
                    <?php foreach ($data['totalLogins'] as $index => $login): ?>
                        <div class="card">
                            ...
                            <div id="loginCollapse-<?php echo $index; ?>" class="collapse" aria-labelledby="loginHeading-<?php echo $index; ?>" data-parent="#loginsAccordion">
                                <div class="card-body">
                                    <p><strong>Total Logins:</strong> <?php echo $login['total_logins']; ?></p>
                                </div>
                            </div>
                        </div>
                    <?php endforeach; ?>
